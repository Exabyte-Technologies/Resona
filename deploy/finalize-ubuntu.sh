...
required_env=(SECRET_KEY DATABASE_PATH RESONA_STORAGE_ROOT RESONA_USER_QUOTA_BYTES ADMIN_USERNAME ADMIN_PASSWORD CLOSEAI_BASE_URL CLOSEAI_API_KEY CLOSEAI_MODEL RESEND_API_KEY RESEND_FROM_EMAIL RESEND_FROM_NAME CAPTCHA_CHALLENGE_COUNT CAPTCHA_CHALLENGE_DIFFICULTY LETSENCRYPT_EMAIL PUBLIC_BASE_URL SESSION_COOKIE_SECURE)
