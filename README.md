...
Set `CLOSEAI_PREFER_ENV=1` in managed deployments so the current environment key, base URL, and model take precedence over older provider values retained in SQLite. The bundled GitHub Actions deployment enables this automatically.
